...
도구 사용 스위치는 **설정 > 도구**에만 있습니다. 같은 화면의 **문서 기술**에서 Markdown, HTML, Excel, Word, PowerPoint를 각각 켜거나 끌 수 있습니다. 끈 기술은 모델이 사용할 수 있는 도구 목록에서 제외되고 실행 단계에서도 차단됩니다. 채팅 화면에는 반복해서 표시하지 않습니다.
