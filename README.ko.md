...
친구에게 기억해 달라고 명시적으로 말하면 Aura는 답변 전에 해당 친구의 개인 Obsidian 호환 Markdown 보관함에 메모를 저장합니다. 이후 같은 친구와의 관련 대화에서 메모를 다시 불러옵니다. 기억 창에서 보관함 폴더를 바로 열 수 있으며, 공통 보관함과 친구별 보관함은 각각 `MEMORY.md` 색인과 개별 Markdown 메모를 가집니다.
